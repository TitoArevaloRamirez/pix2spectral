...
#   --stages auto \
#   --output-dir ~/Results/pix2spectral_inference/vineyard/test
#
# python infer_generate_spectra.py \
...
#   --experiment-prefix vineyard \
#   --stages auto \
#   --output-dir ~/Results/pix2spectral_inference/vineyard/train
#
# python infer_generate_spectra.py \
...
#   --experiment-prefix vineyard \
#   --stages auto \
#   --output-dir ~/Results/pix2spectral_inference/vineyard/val
